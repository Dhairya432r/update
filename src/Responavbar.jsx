...
const Topnav = () => {
    ...
    return (
        <Disclosure as="nav" className="bg-blue-400">
            {({ open }) => (
                <>
                    <div className="mx-auto max-w-7xl text-5xl px-2 sm:px-6 lg:hidden lg:px-8">
                        <div className="relative flex lg:hidden h-20 font-extrabold items-center justify-between">
