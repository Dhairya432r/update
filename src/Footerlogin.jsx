    ...
    return(
        ...
        <div className=''>
            <div className='pl-10 pt-5 mb-5  sm:inline-block lg:flex justify-start'>
                ...
                <span className='text-blue-500 bg-white pt-2  border-2 h-11 w-24 border-blue-500 grid justify-center ml-5 hover:text-white hover:bg-blue-500'><Link to="/Blogs2">Blog</Link></span>
                <h2 className='lg:pl-32 lg:ml-10 sm:pl-28 text-3    xl text-black sm:inline-block lg:flex'>Download</h2>
                <div className='flex'><img src="./assets/images/Logo-app-Instalcion-Google-Play-Store.png" className='h-7 w-28  ml-4' alt="" />
                <img src="./assets/images/Download_on_the_App_.png" className='h-7 flex w-28' alt="" /></div>
                <h1 className='lg:ml-36 sm:ml-32  lg:text-xl text-black'>Follow Us:</h1>
